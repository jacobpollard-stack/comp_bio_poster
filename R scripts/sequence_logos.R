...
crop_post <- subseq(alm_post, start = start_pos, end = end_pos)

# Convert cropped sequences to character vectors

pre <- paste(crop_pre, collapse = "")
post <- paste(crop_post, collapse = "")
